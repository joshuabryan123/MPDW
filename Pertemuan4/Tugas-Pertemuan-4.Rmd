...
<br>
Terlihat bahwa nilai autokorelasi pada data empiris mendekati nilai autokorelasi secara teoritis. Meskipun model MA(2) mengalami **cut-off** setelah lag kedua, akan tetapi nilai lag ketiga pada data empiris tidak benar-benar menyentuh angka 0, hanya mendekati nilai 0.
...
```
<br>
Pada plot PACF, baik pada data bangkitan secara manual maupun menggunakan fungsi, grafik dimulai dari lag 1. Selanjutnya, terlihat bahwa proses AR(2) mengalami **cut-off** setelah lag kedua.
